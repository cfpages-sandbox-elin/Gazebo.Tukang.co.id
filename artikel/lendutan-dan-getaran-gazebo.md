---
article_id: GZB-05-04
title: "Lendutan, getaran, dan rasa kokoh pada gazebo"
slug: "lendutan-dan-getaran-gazebo"
...
date_modified: null
parent_topic: GZB-05
primary_intent: "Understand serviceability symptoms and the evidence needed to assess them."
reader_community: "Tukang.co.id"
reader_address: "Teman Tukang.co.id"
final_route: "/artikel/lendutan-dan-getaran-gazebo.html"
...
# Lendutan, getaran, dan rasa kokoh pada gazebo

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Lendutan, getaran, dan rasa kokoh pada gazebo”
...
- **Primary intent:** Understand serviceability symptoms and the evidence needed to assess them.
...
- **Scope boundary:** Does not prescribe limits or certify safety; qualified structural review is required.
- **Final public route:** `/artikel/lendutan-dan-getaran-gazebo.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Lendutan, getaran, dan rasa kokoh pada gazebo**.
...
- `GZB-05-03` → `/artikel/beban-atap-dan-penggunaan-gazebo.html` — Beban atap dan penggunaan yang perlu dicatat
- `GZB-05-05` → `/artikel/bentang-dan-overhang-gazebo.html` — Pengaruh bentang dan overhang pada konsep gazebo
- `GZB-05-06` → `/artikel/dokumen-perhitungan-struktur-gazebo.html` — Dokumen perhitungan struktur gazebo yang perlu diperiksa
...
- **Tie back to this article:** Keep the explanation specific to “Lendutan, getaran, dan rasa kokoh pada gazebo”.
