---
article_id: GZB-11-03
title: "Stopkontak dan pengisian perangkat di gazebo"
slug: "stopkontak-di-gazebo-outdoor"
description: "Define safe utility needs and specialist checks for an occupied outdoor structure."
status: outline
publication_date: "2026-04-09"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: GZB-11
primary_intent: "Identify user needs, outdoor exposure, protection, cable routes, and misuse risks."
reader_community: "Tukang.co.id"
reader_address: "Kawan Tukang.co.id"
final_route: "/artikel/stopkontak-di-gazebo-outdoor.html"
...
# Stopkontak dan pengisian perangkat di gazebo

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Stopkontak dan pengisian perangkat di gazebo”
- **Reader and situation:** Define safe utility needs and specialist checks for an occupied outdoor structure.
- **Reader outcome:** Define safe utility needs and specialist checks for an occupied outdoor structure.
- **Primary intent:** Identify user needs, outdoor exposure, protection, cable routes, and misuse risks.
...
- **Scope boundary:** No wiring instructions; current electrical rules and qualified installation are mandatory.
- **Final public route:** `/artikel/stopkontak-di-gazebo-outdoor.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Stopkontak dan pengisian perangkat di gazebo**.
...
- `GZB-11-01` → `/artikel/keselamatan-listrik-gazebo-outdoor.html` — Checklist keselamatan listrik untuk gazebo outdoor
- `GZB-11-02` → `/artikel/pencahayaan-gazebo-sesuai-aktivitas.html` — Merancang pencahayaan gazebo sesuai aktivitas
- `GZB-11-04` → `/artikel/perangkat-gantung-pada-gazebo.html` — Memasang kipas atau perangkat gantung pada gazebo
- `GZB-11-05` → `/artikel/area-memasak-dekat-gazebo.html` — Area memasak dekat gazebo: jarak dan kontrol risiko
...
- **Tie back to this article:** Keep the explanation specific to “Stopkontak dan pengisian perangkat di gazebo”.
