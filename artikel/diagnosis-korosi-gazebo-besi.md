---
article_id: GZB-14-04
title: "Karat pada gazebo besi: kapan perlu pemeriksaan lanjut"
slug: "diagnosis-korosi-gazebo-besi"
description: "Inspect a gazebo, diagnose common symptoms, and decide when specialist repair or replacement is needed."
status: outline
publication_date: "2026-06-22"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: GZB-14
primary_intent: "Record coating failure, section loss, water traps, connections, spread, and exposure."
reader_community: "Tukang.co.id"
reader_address: "Sobat Tukang.co.id"
final_route: "/artikel/diagnosis-korosi-gazebo-besi.html"
...
# Karat pada gazebo besi: kapan perlu pemeriksaan lanjut

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Karat pada gazebo besi: kapan perlu pemeriksaan lanjut”
- **Reader and situation:** Inspect a gazebo, diagnose common symptoms, and decide when specialist repair or replacement is needed.
- **Reader outcome:** Inspect a gazebo, diagnose common symptoms, and decide when specialist repair or replacement is needed.
- **Primary intent:** Record coating failure, section loss, water traps, connections, spread, and exposure.
...
- **Scope boundary:** Screening only; remaining capacity and repair design require qualified inspection.
- **Final public route:** `/artikel/diagnosis-korosi-gazebo-besi.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Karat pada gazebo besi: kapan perlu pemeriksaan lanjut**.
...
- `/gazebo-besi/` — use only if it helps the reader's next step; verify the anchor describes the destination.
...
- `GZB-14-02` → `/artikel/diagnosis-kebocoran-gazebo.html` — Gazebo bocor: alur diagnosis dari atap ke drainase
- `GZB-14-03` → `/artikel/diagnosis-kerusakan-kayu-gazebo.html` — Kayu gazebo retak, lapuk, atau berubah bentuk
- `GZB-14-05` → `/artikel/retak-dan-penurunan-gazebo-beton.html` — Retak dan penurunan pada gazebo beton
- `GZB-14-06` → `/artikel/perbaikan-penguatan-atau-penggantian-gazebo.html` — Memilih perbaikan, penguatan, atau penggantian gazebo
...
- **Tie back to this article:** Keep the explanation specific to “Karat pada gazebo besi: kapan perlu pemeriksaan lanjut”.
