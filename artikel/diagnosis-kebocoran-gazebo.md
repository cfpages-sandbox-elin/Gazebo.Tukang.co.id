---
article_id: GZB-14-02
title: "Gazebo bocor: alur diagnosis dari atap ke drainase"
slug: "diagnosis-kebocoran-gazebo"
...
date_modified: null
parent_topic: GZB-14
primary_intent: "Trace water paths, weather conditions, joints, penetrations, overflow, and concealed risk."
reader_community: "Tukang.co.id"
reader_address: "Sobat Tukang.co.id"
final_route: "/artikel/diagnosis-kebocoran-gazebo.html"
...
# Gazebo bocor: alur diagnosis dari atap ke drainase

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Gazebo bocor: alur diagnosis dari atap ke drainase”
...
- **Primary intent:** Trace water paths, weather conditions, joints, penetrations, overflow, and concealed risk.
...
- **Scope boundary:** Diagnostic sequence only; hazardous access and repairs require competent personnel.
- **Final public route:** `/artikel/diagnosis-kebocoran-gazebo.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Gazebo bocor: alur diagnosis dari atap ke drainase**.
...
- `GZB-14-01` → `/artikel/jadwal-perawatan-gazebo.html` — Jadwal inspeksi dan perawatan gazebo berbasis risiko
- `GZB-14-03` → `/artikel/diagnosis-kerusakan-kayu-gazebo.html` — Kayu gazebo retak, lapuk, atau berubah bentuk
- `GZB-14-04` → `/artikel/diagnosis-korosi-gazebo-besi.html` — Karat pada gazebo besi: kapan perlu pemeriksaan lanjut
...
- **Tie back to this article:** Keep the explanation specific to “Gazebo bocor: alur diagnosis dari atap ke drainase”.
